      ...
      <div class="row g-4">
        ...
        <aside class="col-lg-4">
          ...
          <?php
            $sql = "SELECT 
                    p.id_pertandingan,
                    th.nama_tim AS tim_home,
                    ta.nama_tim AS tim_away,
                    th.`Logo Tim` AS logo_home,
                    ta.`Logo Tim` AS logo_away,
                    p.skor_tim_home,
                    p.skor_tim_away
                  FROM pertandingan p
            ...
            if ($result->num_rows > 0) {
              echo '<div class="board">
                      <div class="head">
                        <h6 class="m-0 fw-bold">Pertandingan Terakhir</h6>
                        <span class="badge-pill">I-League 2025</span>
                      </div>';
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                <div class="fixture">
                  <div class="team">
                    <img src="' . $row["logo_home"] . '" alt="logo" class="crest">
                    <span>' . htmlspecialchars($row["tim_home"]) . '</span>
                  </div>

                  <div class="score">' . $row["skor_tim_home"] . ' - ' . $row["skor_tim_away"] . '</div>

                  <div class="team justify-content-end text-end">
                    <span>' . htmlspecialchars($row["tim_away"]) . '</span>
                    <img src="' . $row["logo_away"] . '" alt="logo" class="crest">
                  </div>
                </div>';
              }

              echo '</div>'; // Tutup .board
            } else {
